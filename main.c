...
// This App is implemented using nested BST's
int notesCount = 0;
        ...
        while(count>=0)
        {
            ...
            else
            {
                if(flag==0)
                    ...
                    fprintf(fp,"%d-%d-%d\n%d:%d\n%s\n",hourRoot->note[count]->day,hourRoot->note[count]->month,hourRoot->note[count]->year,hourRoot->note[count]->hour,hourRoot->note[count]->minute,hourRoot->note[count]->comment);
...
int main()
{
    ...
    printf("********************************************************************************\n");
        printf("                                 REMINDER APP                                   \n");
        printf("********************************************************************************\n");
        printf("\t\t\t\t\t\tTIME [ 24 hours ] = %02d:%02d:%02d \n",hour,min,sec);
    ...
    if(yearRoot!=NULL)
    {
        ...
        printf("\t No reminders is setted yet ..!\n\n");
    printf("--------------------------------------------------------------------------------\n\n\n\n");
    system("echo press any key to go back to main menu...");
    system("pause >nul");
    ...
    system("color 0b");
    printf("\n\n\n\n\n\tThanks for using the \"REMINDER APP\"...............!\n\n");

    printf("\n\n\n\n\n\n\n\n\tPress any key to Exit REMINDER APP.....\n");
    system("pause >nul");
